...
export default function ExpensesPage() {
    ...
    const expenses = transactions.filter((tx) => tx.amount < 0 && tx.category !== "no_computable");
    const months = getAvailableMonths(expenses);
    const visible = selectedMonth === "all" ? expenses : filterByMonth(expenses, selectedMonth);
